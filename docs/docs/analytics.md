...
- **Advanced ratios** – `omega`, `tail_ratio`, `common_sense_ratio`, `information_ratio`, and `r_squared` highlight distributional skew, tail leverage, benchmark tracking, and explained variance.
